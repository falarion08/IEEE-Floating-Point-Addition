...
// Normalizes and return an object containing the normalized binary as a string, and an exponent which contains the number of alignments made 
 ...
 if((operand[0] != '1' || operand[1] != '.') && operand.length != 0){
...
function saveFile() {
    var content =  form.querySelector('#operand1').value + " + " + form.querySelector('#operand2').value +
                "\n" + rounding_rule.innerHTML +
                "\nSuppported number of digits: " + form.querySelector('#digit_support').value + 
